...
DATABASES = {
    'default': {
        ...
        'NAME': 'legalczar',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/var/www/legalczar/media/'
...
STATIC_ROOT = '/var/www/legalczar/static/'
...
SECRET_KEY = 'l=md&v#ck&d=11dx77d5+_fuv*9ma4npz=rdwz7br!fg06vl)s'
...
ROOT_URLCONF = 'legalczar.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'legalczar.wsgi.application'
