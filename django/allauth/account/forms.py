...
class PasswordField(forms.CharField):
    ...
    def __init__(self, *args, **kwargs):
        ...
        kwargs['widget'] = forms.PasswordInput(render_value=render_value,
                                               attrs={'placeholder':
                                                      kwargs.pop('placeholder',"Password")})
                                                       # _('Password')})
    ...
    def __init__(self, *args, **kwargs):
        ...
        if app_settings.AUTHENTICATION_METHOD == AuthenticationMethod.EMAIL:
            ...
            login_widget = forms.TextInput(attrs={
                                                     'placeholder':_('Username or E-mail address'), 
...
class SignupForm(BaseSignupForm):
    ...
    password2 = PasswordField(label='',placeholder=_('Password (again)') )
    ...
    def __init__(self, *args, **kwargs):
        ...
        #added next 3 lines for field order
        field_order = ['email', 'password1', 'password2', 'barid','profile']
        other_field_order = [ f for f in self.fields.keyOrder
                              if f not in field_order ]
        self.fields.keyOrder = field_order + other_field_order                      
